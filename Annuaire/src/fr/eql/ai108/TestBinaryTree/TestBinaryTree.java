...
public class TestBinaryTree {
	public BinaryTreeStagiaire btst;
...
//		btst.add(stagiaire8);
		...
		//System.out.println("\r\n" + btst.traverseToList());
		System.out.println(btst.traverseToListRaf());
		
	}

	public BinaryTreeStagiaire getBtst() {
		return btst;
	}

	public void setBtst(BinaryTreeStagiaire btst) {
		this.btst = btst;
	}
}
